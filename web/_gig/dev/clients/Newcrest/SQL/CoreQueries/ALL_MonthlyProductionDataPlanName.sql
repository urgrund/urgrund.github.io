...
WHERE substring(ats.[shkey],1,4) >= '2018' /*and substring(ats.[shkey],5,2) >  '0'*/ and MTS.MeasCode ='TONNE' and RDF.[Equipment_FunctionCode] = 'LOADING' and RDP.[Source_Category] like '%Production%'
--and RDP.[Source_MineArea_Code] = 'SLC'
