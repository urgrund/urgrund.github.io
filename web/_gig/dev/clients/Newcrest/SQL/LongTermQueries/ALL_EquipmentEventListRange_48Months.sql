...
FROM [dbo].[ALLOCTNTIMESTAMP] as ATS 
	...
	WHERE MTS.MeasCode = 'SECONDS' and RDF.[Equipment_FunctionCode] in ('LOADING','HAULING','P','D') and left(ats.[shkey],8) BETWEEN convert(varchar, getdate()-1461, 112) AND convert(varchar, getdate(), 112)