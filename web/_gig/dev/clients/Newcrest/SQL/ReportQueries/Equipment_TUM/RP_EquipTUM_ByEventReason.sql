...
FROM [dbo].[ALLOCTNTIMESTAMP] as ATS 
	...
	WHERE MTS.MeasCode = 'SECONDS' and  ats.[shkey] between @StartD_S and @EndD_S   and RDF.[Equipment_FunctionCode] in ('LOADING','HAULING','P','D') and RDS.[Status_Description] <> 'Offsite'
